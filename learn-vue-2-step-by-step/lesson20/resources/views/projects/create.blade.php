                ...
                <div class="box">
                    <form @submit.prevent="onSubmit" @keydown="errors.clear($event.target.name)">
                        <div class="field">
                            ...
                            <div class="control">
                                <input v-model="form.name" class="input" type="text" name="name" placeholder="Text input">
                        ...
                        <div class="field">
                            ...
                            <div class="control">
                                <textarea v-model="form.desc" name="desc" class="textarea" placeholder="Textarea"></textarea>
